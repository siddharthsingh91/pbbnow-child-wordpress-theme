...
<div class="container" role="main">
    <div class="row">
        <div class="col-md-8 blog-contaner border-show"><h1 class="title"><?php echo bloginfo(); ?> Blog</h1>
            <div class="row">
        ...
        <?php endif; ?>
                ...
                <div class="client_content detail_single_blog"><?php the_excerpt(); ?></div>
